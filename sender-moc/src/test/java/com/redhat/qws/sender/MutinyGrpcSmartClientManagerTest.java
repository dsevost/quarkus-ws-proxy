...
public class MutinyGrpcSmartClientManagerTest {
    private static final Logger LOGGER = Logger.getLogger(MutinyGrpcSmartClientManagerTest.class);
    ...
    MutinySmartClientGrpc.MutinySmartClientStub grpcSmartClient;

    @Test
    @Order(10)
    public void testNewClientSubscribeStub() {
        Uni<Respond> ureply = grpcSmartClient.subscribe(GrpcProxyServerAdapter
                .buildSmartClientContextWithIP(Util.DEFAULT_USER_NAME, DEFAULT_CLIENT_ID, Util.DEFAULT_LEGACY_IP));
        ureply.subscribe().with(reply -> {
    ...
    public void testUnsubscribeClientSubscribeStub() {
        Uni<Respond> ureply = grpcSmartClient.unsubscribe(GrpcProxyServerAdapter
                .buildSmartClientContextWithIP(Util.DEFAULT_USER_NAME, DEFAULT_CLIENT_ID, Util.DEFAULT_LEGACY_IP));
        ureply.subscribe().with(reply -> {
